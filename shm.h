...
//We open a file and map this file in the virtual memory of ./out
//,and then request a 4k page cache in physical memory when we are doing memcpy() that gets page fault. 
//So, we can read the contents written by another bin, since they use the same physical memory in the user space.
